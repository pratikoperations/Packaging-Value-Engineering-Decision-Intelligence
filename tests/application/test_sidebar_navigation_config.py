...
class SidebarNavigationConfigTests(unittest.TestCase):
    ...
    def test_mobile_sidebar_width_rule_is_bounded(self):
        ...
        self.assertIn("width: clamp(210px, 62vw, 240px) !important;", source)
        self.assertIn("flex-basis: clamp(210px, 62vw, 240px) !important;", source)
        self.assertIn("max-width: 240px !important;", source)
        self.assertIn("min-width: 210px !important;", source)
