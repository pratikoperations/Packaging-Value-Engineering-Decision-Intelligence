...
- Status: Builds 1, 2A, 2B and 3 implemented; Build 3 validation and merge remain pending.
- Implementation started: yes, limited to Builds 1, 2A, 2B and 3.
...
- Build 3 status: implementation complete on controlled branch; CI and governance closure pending.
- Builds 4–8: not started and not authorized.
- Release completion: 43.5%.
- Completed planned effort: 30 of 69 hours.
- Pending planned effort: 39 hours, 56.5%.
...
| 3 | Trial planning and validation requirements | 9 | 30 | 43.5% | Implemented; validation pending |
...
### Delivered
- schema v6 immutable trial-plan register;
- trial objective, protocol, owner, site and planned dates;
- drawing-evidence and specification-version linkage;
- governed evidence requirements and measurable acceptance criteria;
- prerequisites and blockers;
- explicit human authorization status and authorizer identity;
...
Build 3 alone is authorized beyond governance-closed Builds 1, 2A and 2B. Builds 4–8 require separate explicit authorization. Build 3 must pass CI, review, merge and post-merge controls before it is governance-closed.
